...
export default function ChatItem() {
  return (
    <ContextMenu dir="rtl">
      <ContextMenuTrigger>
        <div className="w-full flex items-center gap-4 pr-2 pt-2 select-none active:bg-gray-50 cursor-pointer hover:bg-gray-100 rounded-tl-sm transition-all duration-400">
          ...
          <div className="w-full flex flex-col pb-3">
            ...
            <div className="w-full flex justify-between items-center">
              <p className="mt-1 text-[12.5px] line-clamp-1 text-gray-700 md:text-[13px] lg:text-sm ml-5">
                سلام اقا خوبی چطوری حالت چطوره؟ سلام اقا خوبی چطوری حالت چطوره؟
